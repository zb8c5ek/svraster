...
do
    echo "============ start " $scene " ============"
    lanuch_exp $scene $1 --res_downscale 1.0 --cfg_files cfg/mipnerf360.yaml "${@:2}"
    echo "============ end " $scene " ============"
done
...
do
    echo "============ start " $scene " ============"
    lanuch_exp $scene $1 --res_downscale 1.0 --cfg_files cfg/deep_blending.yaml "${@:2}"
    echo "============ end " $scene " ============"
done
